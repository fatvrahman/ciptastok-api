...
        ? 1 / user.avg_hours_per_assignment
        : 0;
...
            ? "zero"
          : "negative",
        totalAssignments: user.recent_assignments
      };
    });
...
// <-- [PERBAIKAN] Pastikan kurung '};' dari getMonthlyStats ada DI ATAS INI.

// --- [PERBAIKAN] Fungsi baru ditambahkan di sini, DI LUAR fungsi lainnya ---
// Ini untuk endpoint GET /api/dashboard/low-stock
export const getLowStockProducts = async (req, res) => {
  try {
    // Query ini mencari produk dari WH02 (sesuai screenshot error log sebelumnya)
    // yang stoknya di bawah 10 TAPI DI ATAS 0.
